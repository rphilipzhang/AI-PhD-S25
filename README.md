...
### 📚 Session 7. LLM Posttraining & Inference (Feb/25/2025)
- 🔑 **Keywords**: Posttraining, SFT, PEFT, RLHF, DPO, Test-Time Scaling, Knowledge Distillation, Inference, Quantization
...
- 📚 **References**:
    ...
    - Miscellaneous Resources: [Video on DeepSeek R1](https://www.youtube.com/watch?v=tRuN8xYdETs), [Video on DeekSeep MLA](https://www.bilibili.com/video/BV1HqFQezEMt/), [Approximating KL Divergence](http://joschu.net/blog/kl-approx.html)
